...
| <a name="input_enable_v1fs_telemetry_kube_state_metrics"></a> [enable\_v1fs\_telemetry\_kube\_state\_metrics](#input\_enable\_v1fs\_telemetry\_kube\_state\_metrics) | Whether to enable kube-state-metrics for Kubernetes resource metrics | `bool` | `true` | no |
| <a name="input_enable_v1fs_telemetry_prometheus"></a> [enable\_v1fs\_telemetry\_prometheus](#input\_enable\_v1fs\_telemetry\_prometheus) | Whether to enable Prometheus agent for metrics collection and forwarding to Vision One | `bool` | `true` | no |
...
| <a name="input_v1fs_database_cpu_limit"></a> [v1fs\_database\_cpu\_limit](#input\_v1fs\_database\_cpu\_limit) | CPU limit for database container pods | `string` | `"500m"` | no |
| <a name="input_v1fs_database_cpu_request"></a> [v1fs\_database\_cpu\_request](#input\_v1fs\_database\_cpu\_request) | CPU request for database container pods | `string` | `"250m"` | no |
| <a name="input_v1fs_database_memory_limit"></a> [v1fs\_database\_memory\_limit](#input\_v1fs\_database\_memory\_limit) | Memory limit for database container pods | `string` | `"1Gi"` | no |
| <a name="input_v1fs_database_memory_request"></a> [v1fs\_database\_memory\_request](#input\_v1fs\_database\_memory\_request) | Memory request for database container pods | `string` | `"512Mi"` | no |
...
| <a name="input_v1fs_helm_chart_version"></a> [v1fs\_helm\_chart\_version](#input\_v1fs\_helm\_chart\_version) | Version of Vision One File Security Helm chart | `string` | `"1.4.1"` | no |
...
| <a name="input_v1fs_kube_state_metrics_cpu_limit"></a> [v1fs\_kube\_state\_metrics\_cpu\_limit](#input\_v1fs\_kube\_state\_metrics\_cpu\_limit) | CPU limit for kube-state-metrics pods | `string` | `"100m"` | no |
| <a name="input_v1fs_kube_state_metrics_cpu_request"></a> [v1fs\_kube\_state\_metrics\_cpu\_request](#input\_v1fs\_kube\_state\_metrics\_cpu\_request) | CPU request for kube-state-metrics pods | `string` | `"50m"` | no |
| <a name="input_v1fs_kube_state_metrics_memory_limit"></a> [v1fs\_kube\_state\_metrics\_memory\_limit](#input\_v1fs\_kube\_state\_metrics\_memory\_limit) | Memory limit for kube-state-metrics pods | `string` | `"128Mi"` | no |
| <a name="input_v1fs_kube_state_metrics_memory_request"></a> [v1fs\_kube\_state\_metrics\_memory\_request](#input\_v1fs\_kube\_state\_metrics\_memory\_request) | Memory request for kube-state-metrics pods | `string` | `"64Mi"` | no |
...
| <a name="input_v1fs_management_plugins"></a> [v1fs\_management\_plugins](#input\_v1fs\_management\_plugins) | List of plugins to enable for management service.<br/>Each plugin requires ALL fields to be specified.<br/><br/>Required fields for ontap-agent:<br/>  - name               (required) - Plugin identifier (e.g., "ontap-agent")<br/>  - enabled            (required) - Whether the plugin is enabled<br/>  - configMapName      (required) - Name of the ConfigMap for plugin configuration<br/>  - securitySecretName (required) - Name of the Secret for security credentials<br/>  - jwtSecretName      (required) - Name of the Secret for JWT token<br/><br/>Example (ontap-agent):<br/>  v1fs\_management\_plugins = [<br/>    {<br/>      name               = "ontap-agent"<br/>      enabled            = true<br/>      configMapName      = "ontap-agent-config"<br/>      securitySecretName = "ontap-agent-security"<br/>      jwtSecretName      = "ontap-agent-jwt"<br/>    }<br/>  ] | `list(map(any))` | `[]` | no |
...
| <a name="input_v1fs_prometheus_cpu_limit"></a> [v1fs\_prometheus\_cpu\_limit](#input\_v1fs\_prometheus\_cpu\_limit) | CPU limit for Prometheus agent pods | `string` | `"200m"` | no |
| <a name="input_v1fs_prometheus_cpu_request"></a> [v1fs\_prometheus\_cpu\_request](#input\_v1fs\_prometheus\_cpu\_request) | CPU request for Prometheus agent pods | `string` | `"100m"` | no |
| <a name="input_v1fs_prometheus_log_level"></a> [v1fs\_prometheus\_log\_level](#input\_v1fs\_prometheus\_log\_level) | Log level for Prometheus agent (debug, info, warn, error) | `string` | `"info"` | no |
| <a name="input_v1fs_prometheus_memory_limit"></a> [v1fs\_prometheus\_memory\_limit](#input\_v1fs\_prometheus\_memory\_limit) | Memory limit for Prometheus agent pods | `string` | `"256Mi"` | no |
| <a name="input_v1fs_prometheus_memory_request"></a> [v1fs\_prometheus\_memory\_request](#input\_v1fs\_prometheus\_memory\_request) | Memory request for Prometheus agent pods | `string` | `"128Mi"` | no |
| <a name="input_v1fs_prometheus_scrape_interval"></a> [v1fs\_prometheus\_scrape\_interval](#input\_v1fs\_prometheus\_scrape\_interval) | Prometheus scrape interval (e.g., '60s', '30s') | `string` | `"60s"` | no |
