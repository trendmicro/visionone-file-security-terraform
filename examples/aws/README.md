...
| <a name="input_v1fs_helm_chart_version"></a> [v1fs\_helm\_chart\_version](#input\_v1fs\_helm\_chart\_version) | Version of Vision One File Security Helm chart | `string` | `"1.4.2"` | no |
